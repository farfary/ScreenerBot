...
pub use schemas::{
    ...
    InterfaceConfig, LockscreenConfig, MaintenanceConfig, MonitoringConfig, OhlcvConfig,
    PerformanceConfig, PoolsConfig, PositionsConfig, RpcConfig, ServicesConfig, SolPriceConfig,
