...
fn format_tag(tag: &LogTag) -> ColoredString {
    match tag {
        ...
        LogTag::Unknown => format!("{:<width$}", "UNKNOWN", width = TAG_WIDTH)
            .white()
            .dimmed(),
        LogTag::AI => format!("{:<width$}", "AI", width = TAG_WIDTH)
            .bright_purple()
            .bold(),
        ...
        LogTag::Webserver => format!("{:<width$}", "WEBSERVER", width = TAG_WIDTH)
            .bright_green()
            .bold(),
        LogTag::Notifications => format!("{:<width$}", "NOTIFY", width = TAG_WIDTH)
            .bright_purple()
            .bold(),
        LogTag::Telegram => format!("{:<width$}", "TELEGRAM", width = TAG_WIDTH)
            .bright_cyan()
            .bold(),
