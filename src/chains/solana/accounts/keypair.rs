...
pub fn generate_wallet_material() -> Result<(String, EncryptedData), String> {
...
pub fn import_wallet_material(private_key: &str) -> Result<(String, EncryptedData), String> {
...
pub fn address_from_private_key(private_key: &str) -> Result<String, String> {
...
pub fn address_from_encrypted_key(ciphertext: &str, nonce: &str) -> Result<String, String> {
...
mod tests {
    ...
    fn invalid_base58_error_does_not_echo_the_input() {
        ...
        let err = parse_private_key(secret_like_but_invalid).unwrap_err();
        assert!(
    ...
    fn wrong_length_array_error_does_not_echo_byte_values() {
        ...
        let err = parse_private_key(&array_str).unwrap_err();
