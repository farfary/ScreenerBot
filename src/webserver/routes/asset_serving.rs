...
pub async fn get_ui_script(axum::extract::Path(file): axum::extract::Path<String>) -> Response {
    let content = match file.as_str() {
        ...
        "token_details/trade_actions.js" => Some(templates::TOKEN_DETAILS_TRADE_ACTIONS_UI),
        "token_details/transactions_tab.js" => Some(templates::TOKEN_DETAILS_TRANSACTIONS_TAB_UI),
        "token_details/chart_tab.js" => Some(templates::TOKEN_DETAILS_CHART_TAB_UI),
        "token_details/utilities.js" => Some(templates::TOKEN_DETAILS_UTILITIES_UI),
        ...
        "settings/interface_tab.js" => Some(templates::SETTINGS_INTERFACE_TAB_UI),
        "settings/navigation_tab.js" => Some(templates::SETTINGS_NAVIGATION_TAB_UI),
        "settings/licenses_tab.js" => Some(templates::SETTINGS_LICENSES_TAB_UI),
        "settings/telegram_tab.js" => Some(templates::SETTINGS_TELEGRAM_TAB_UI),
