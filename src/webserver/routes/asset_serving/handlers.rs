...
pub async fn get_page_script(Path(file): Path<String>) -> Response {
    ...
    let content = match file {
        ...
        "copy/charts.js" => Some(embeds::COPY_CHARTS_JS),
        "copy/dialogs.js" => Some(embeds::COPY_DIALOGS_JS),
        "copy/tokens.js" => Some(embeds::COPY_TOKENS_JS),
        "copy/summary.js" => Some(embeds::COPY_SUMMARY_JS),
        "copy/list.js" => Some(embeds::COPY_LIST_JS),
        "copy/workspace.js" => Some(embeds::COPY_WORKSPACE_JS),
        "copy/overview.js" => Some(embeds::COPY_OVERVIEW_JS),
        "copy/execution.js" => Some(embeds::COPY_EXECUTION_JS),
        "copy/rules.js" => Some(embeds::COPY_RULES_JS),
        "copy/policy.js" => Some(embeds::COPY_POLICY_JS),
        "copy/holdings.js" => Some(embeds::COPY_HOLDINGS_JS),
        "copy/activity.js" => Some(embeds::COPY_ACTIVITY_JS),
        "copy/compare.js" => Some(embeds::COPY_COMPARE_JS),
        "copy/editor.js" => Some(embeds::COPY_EDITOR_JS),
        "copy/editor_steps.js" => Some(embeds::COPY_EDITOR_STEPS_JS),
        "copy/arm_gate.js" => Some(embeds::COPY_ARM_GATE_JS),
        "copy/settings.js" => Some(embeds::COPY_SETTINGS_JS),
        "copy/profile.js" => Some(embeds::COPY_PROFILE_JS),
...
pub async fn get_ui_script(Path(file): Path<String>) -> Response {
    ...
    let content = match file {
        ...
        "copy_handoff.js" => Some(embeds::COPY_HANDOFF_UI),
        ...
        "advanced_chart/framing.js" => Some(embeds::ADVANCED_CHART_FRAMING_JS),
