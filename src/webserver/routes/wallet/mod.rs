...
pub fn routes() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/wallet/tokens/refresh", post(handlers::refresh_wallet_tokens))
        .route("/wallet/dashboard", post(handlers::get_wallet_dashboard))
        .route("/wallet/dashboard/refresh", post(handlers::refresh_wallet_dashboard))
        .route("/wallet/flow-cache", get(handlers::get_wallet_flow_cache_stats))
        .route("/wallet/cache-metrics", get(handlers::get_wallet_cache_metrics))
}
