...
export const CONFIG_CATEGORIES = {
  ...
  "On-Chain - Symbol Analysis": {
    source: "onchain",
    fields: [
      {
        key: "reject_numeric_symbols",
      ...
      {
        key: "reject_single_char_symbols",
  ...
  "On-Chain - Authority Analysis": {
    source: "onchain",
    fields: [
      {
        key: "reject_known_scam_authorities",
      ...
      {
        key: "reject_immutable_with_freeze",
